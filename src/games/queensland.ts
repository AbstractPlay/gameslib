import {  GameBase, IAPGameState, IClickResult, IIndividualState, IValidationResult, IScores, IStatus, IRenderOpts, type ChatLogCollectContext, type ChatLogLine } from "./_base.js";
