...
import { cartesianProduct, HexTriGraph, intersects, mergePaths, permute, reviver, shuffle, UserFacingError } from "../common/index.js";
...
export class EstateGame extends GameBase {
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PLACE.estate", {where: r.where!, what: r.what!, count: Number(r.what!)});
                return true;
            case "move":
                return true;
            default:
