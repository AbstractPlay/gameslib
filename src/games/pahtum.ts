...
import { Direction, orthDirections, reviver, shuffle, SquareDirectedGraph, SquareOrthGraph, UserFacingError } from "../common/index.js";
...
export class PahTumGame extends GameBase {
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PLACE.pahtum", {where: r.where!, context: r.what!});
                return true;
            case "convert":
