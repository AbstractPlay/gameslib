...
import { GameBase, GameBaseSimultaneous, GameBaseSkipTurn } from "./_base";

${importLines.join("\n")}

export type GameConstructor = (typeof GameBase | typeof GameBaseSimultaneous | typeof GameBaseSkipTurn) & {
    readonly gameinfo: APGamesInformation;
    create(...args: unknown[]): GameBase | GameBaseSimultaneous | GameBaseSkipTurn;
};
