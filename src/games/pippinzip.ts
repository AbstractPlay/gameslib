import {  GameBase, IAPGameState, IClickResult, ICustomButton, IIndividualState, IValidationResult, type ChatLogCollectContext, type ChatLogLine } from "./_base";
    ...
    public collectChatLogLine(lines: ChatLogLine[], r: APMoveResult, ctx: ChatLogCollectContext): boolean {
        switch (r.type) {
            case "place":
                ...
                return true;
            case "pass":
                this.pushSeatChatLine(lines, ctx.defaultSeat, "apresults:PASS.pippinzip", {});
                return true;
            case "eog":
